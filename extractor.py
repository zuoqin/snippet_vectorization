...
class Extractor:
    def __init__(self, config, jar_path, max_track_length, max_track_width):
        self.config = config
    ...
    def extract_paths(self, path):
        command = ['java', '-cp', self.jar_path, 'JavaExtractor.App', '--max_track_length',
                   str(self.max_track_length), '--max_track_width', str(self.max_track_width), '--file', path, '--no_hash']
