...
class TrainingModelStatus:
    def __init__(self):
        self.nr_epochs_trained: int = 0
        self.trained_full_last_epoch: bool = False


class TrainingModelStatusTrackerCallback(Callback):
    def __init__(self, training_status: TrainingModelStatus):
        self.training_status: TrainingModelStatus = training_status
        super(TrainingModelStatusTrackerCallback, self).__init__()
...
class ModelCheckCallback(Callback):
    """
    ...
    def __init__(self, model_wrapper, nr_epochs_to_save: int = 1,
        ...
        super(ModelCheckCallback, self).__init__()
...
class TrainingModelProgressLoggerCallback(MultiBatchCallback):
    def __init__(self, config: Config, training_status: TrainingModelStatus):
        self.config = config
        self.training_status = training_status
        self.avg_throughput: Optional[float] = None
        super(TrainingModelProgressLoggerCallback, self).__init__(
